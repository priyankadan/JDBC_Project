...
/*
 CREATE OR REPLACE PROCEDURE P_STUDENT_DETAILS_BY_NO 
(
  NO IN NUMBER 
, NAME OUT VARCHAR2 
...
BEGIN
  SELECT SNAME,SADD,AVG INTO NAME,ADDRESS,AVARAGE FROM STUDENT WHERE SNO=NO;
END P_STUDENT_DETAILS_BY_NO;  */

public class CsForProcureCall_Get_StudentDetails_ByID_Test5 {
	public static final String CALL_P_GET_STUDENT_DETAILS_BY_NO="{call P_STUDENT_DETAILS_BY_NO(?,?,?,?)}";
